      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center gap-8">
          <div className="md:w-1/2">
            ...
            <p className="text-[16px] md:text-lg text-gray-700 mb-6 text-center md:text-left">
            ...
            <Link href={"#contact"}>
            <Button className="bg-[#bada34] hover:bg-[#a5c22f] text-white w-full md:w-fit">Get in Touch</Button>
            </Link>
          </div>
          <div className="md:w-1/2">
            <Image
